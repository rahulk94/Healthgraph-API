...
class FitnessActivity(Resource):
    ...
    _prop_main = ('type', 'duration', 'start_time')
...
#Jak trying to make strength activity
class StrengthActivity(Resource):
    
    _content_type = content_types.STRENGTH_ACTIVITY
    _prop_defs = {'uri': PropResourceLink('StrengthActivity'),
                  'userID': None,
                  'type': None,
                  'secondary_type': None,
                  'equipment': None,
                  ...
                  'activity': None,
                  'comments': PropResourceLink('CommentThread'),
                  'previous': PropResourceLink('StrengthActivity'),
                  'next': PropResourceLink('StrengthActivity'),
                  'nearest_teammate_fitness_activities': None,
                  'nearest_strength_training_activity': None,
                  'nearest_teammate_strength_training_activities': None,
                  'nearest_background_activity': None,
    ...
    _prop_main = ('type', 'exercises', 'start_time',)
